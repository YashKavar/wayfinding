...
<?php
    ...
    $sql1 = "UPDATE product SET product.category_name='$category_name', product_name = '$product_name', quantity = '$quantity', product_price = '$price',product_image = '$photo_name', product_longitude = '$longitude', product_latitude = '$latitude', discription = '$discription'
