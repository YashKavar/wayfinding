            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                if(password_verify($password,$db_pass)){
                    ...
                    if(isset($_POST['rememberme'])){
                        ...
                        header("Location: http://esst.infinityfreeapp.com/product-data.php");
                    }
                    else{
                        header("Location: http://esst.infinityfreeapp.com/product-data.php");
                    }     
...
<?php
            ...
            $_SESSION['msg'] = "Your account is not active  OR Your E-mail id and Username is Wrong.";
            header('Location: http://esst.infinityfreeapp.com/login.php');
        }
    }
?>