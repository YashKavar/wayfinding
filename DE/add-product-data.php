...
<?php
        ...
        $sql = "insert into product(user_id,category_name,product_name,quantity,product_price,product_image,product_longitude,product_latitude,discription)
                values('$user_id','$category_name','$product_name','$quantity','$price','$file_name','$longitude','$latitude','$discription')";
        ...
        mysqli_close($conn);
        header("Location: http://localhost/DE/product-data.php");
    } 
?>
